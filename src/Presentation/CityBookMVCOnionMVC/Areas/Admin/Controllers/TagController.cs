...
namespace CityBookMVCOnionMVC.Areas.Admin.Controllers
{
    ...
    public class TagController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateTagVM create)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateTagVM update)
        {
        ...
        {
            GetTagVM get = await _service.GetByIdAsync(id);
