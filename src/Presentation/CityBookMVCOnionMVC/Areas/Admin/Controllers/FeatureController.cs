...
namespace CityBookMVCOnionMVC.Areas.Admin.Controllers
{
    ...
    public class FeatureController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateFeatureVM create)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateFeatureVM update)
        {
        ...
        {
            GetFeatureVM get = await _service.GetByIdAsync(id);
