...
{
    public partial class CreateDbIdentityAndAllTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeReview", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tvit = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MondayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    TuesdayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    WednesdayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    ThursdayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    FridayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    SaturdayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    SundayTo = table.Column<TimeSpan>(type: "time", nullable: true),
                    DayOrMonth = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PlaceFeatures_Features_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationDateTo = table.Column<DateTime>(type: "datetime2", nullable: true),
